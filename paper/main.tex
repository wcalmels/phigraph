...
ledger, deployment boundaries, and Python implementation. Building on this
substrate, we additionally describe PhiGraph HAV v0.2, a fail-closed
...
The software tree contains 128 automated tests: 117 core tests covering
protocol records, ledger integrity, policy evaluation, runtime modes,
persistence backends, API and SDK boundaries, agent workflows, graph
operations, benchmarks, and deployment configuration, plus 11 HAV-specific
...
isolated environment, and build the Docker image. A local run on July 29, 2026
executed all 128 tests successfully. A separate synthetic benchmark attempt
